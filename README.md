...
- Outputs of the module are Arduino Pins D0-D5, note that the output is inverted! As extra circuitry had to be implemented  on the input to level up the logic level of the FPGA (3.3V).
